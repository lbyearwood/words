-- Keep practice selection entirely statement-local.  The previous implementation
-- used function-local temporary tables, which worked at runtime but caused
-- `supabase db lint` to resolve their relations before they existed.
